...
const GoogleLogo = () => (
  ...
  >
    <path
      fill="#EA4335"
      d="M17.64 9.2045c0-.6381-.0573-1.2513-.1636-1.8387H9v3.4768h4.8445c-.2096 1.1281-.8463 2.0836-1.8057 2.7217v2.2589h2.9104c1.7079-1.5726 2.6779-3.8893 2.6779-6.6398z"
    />
    <path
      fill="#34A853"
      d="M9 18c2.43 0 4.4673-.8067 5.9564-2.1733l-2.9104-2.2589c-.8067.5436-1.8371.8654-3.0458.8654-2.338 0-4.3227-1.5791-5.0349-3.7013H.9578v2.3324C2.4382 15.9832 5.4818 18 9 18z"
    />
    <path
      fill="#4A90E2"
      d="M3.964 10.7067C3.7848 10.2373 3.6818 9.7211 3.6818 9.1867c0-.5344.103-1.0506.2822-1.52V4.9578H.9578C.3477 6.1732 0 7.5489 0 9c0 .5511.0661 1.0879.1899 1.6104l3.7741-1.9037z"
    />
    <path
      fill="#FBBC05"
      d="M9 3.5795c1.3227 0 2.5147.4552 3.452 1.2013l2.5549-2.5549C13.4588.8886 11.3927 0 9 0 5.4818 0 2.4382 2.0168.9578 4.9578l3.7741 2.3324C5.6779 4.1586 7.322 3.5795 9 3.5795z"
    />
  </svg>
);
...
export function SignupPage() {
  ...
  const completedRequirements = passwordRequirements.filter((req) =>
    req.check(formData.password),
  ).length;
  ...
  return (
    <div className="min-h-screen bg-white flex">
      <div className="mx-auto max-w-sm px-4 py-6 flex-1">
        {/* Header & Navigation */}
        <div className="mb-8">
          {/* Back Navigation */}
          <button
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-[#FF8C42] leading-relaxed">
            Sign up to access your cart, track orders, and enjoy a personalized
            shopping experience.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center gap-3 mt-6">
            ...
            <label
              htmlFor="terms"
              className="text-sm text-[#717182] leading-relaxed"
            >
          ...
          <div className="flex justify-center lg:justify-end mt-8">
            <button
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.backgroundColor = "#E67E36")
              }
              onMouseLeave={(e) =>
          ...
          >
            ...
            <span
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.textDecorationColor = "#FF8C42";
              }}
              onMouseLeave={(e) => {
