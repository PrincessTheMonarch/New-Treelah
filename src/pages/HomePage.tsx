      ...
      <section className="py-20 bg-secondary text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
            We specialize in personalized gifts and bulk orders. Let us help you
            create something truly memorable!
          </p>
          <div className="flex flex-row gap-4 justify-center">
            <button className="text-sm px-8 py-3 bg-primary text-white rounded-full hover:shadow-xl transition-shadow">
              Request Custom Gifts
            </button>
            <button className="text-sm px-8 py-3 border-2 border-primary text-primary rounded-full bg-white hover:bg-white/90 hover:text-primary transition-colors">
              Corporate Gifting
            </button>
          </div>
        </div>
