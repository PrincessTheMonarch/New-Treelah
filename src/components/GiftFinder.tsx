  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    if (formData.occasion) {
      ...
      const occasionFormatted =
        formData.occasion.charAt(0).toUpperCase() + formData.occasion.slice(1);
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <div className="flex items-center justify-center gap-3 flex-wrap text-white">
            <span className="text-lg">
              Not sure what to get? Let's help you find the perfect gift, tell
              us about the receiver!
            </span>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div style={{ display: "flex", gap: "12px" }}>
                  <button
                    type="button"
                    onClick={() =>
                      setFormData({ ...formData, recipient: "male" })
                    }
                    style={{
                      flex: 1,
                      padding: "12px 16px",
                      ...
                      backgroundColor:
                        formData.recipient === "male" ? "#FF8C42" : "white",
                      color:
                        formData.recipient === "male" ? "white" : "#374151",
                      fontSize: "14px",
                      fontWeight: "600",
                      cursor: "pointer",
                      transition: "all 0.2s ease",
                      boxShadow:
                        formData.recipient === "male"
                          ? "0 4px 6px rgba(255, 140, 66, 0.3)"
                          : "none",
                    }}
                  >
                    For Him
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setFormData({ ...formData, recipient: "female" })
                    }
                    style={{
                      flex: 1,
                      padding: "12px 16px",
                      ...
                      border: "1px solid #E5E7EB",
                      backgroundColor:
                        formData.recipient === "female" ? "#FF8C42" : "white",
                      color:
                        formData.recipient === "female" ? "white" : "#374151",
                      fontSize: "14px",
                      fontWeight: "600",
                      cursor: "pointer",
                      transition: "all 0.2s ease",
                      boxShadow:
                        formData.recipient === "female"
                          ? "0 4px 6px rgba(255, 140, 66, 0.3)"
                          : "none",
                    }}
                  >
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setFormData({ ...formData, recipient: "other" })
                    }
                    style={{
                      flex: 1,
                      padding: "12px 16px",
                      ...
                      border: "1px solid #E5E7EB",
                      backgroundColor:
                        formData.recipient === "other" ? "#FF8C42" : "white",
                      color:
                        formData.recipient === "other" ? "white" : "#374151",
                      fontSize: "14px",
                      fontWeight: "600",
                      cursor: "pointer",
                      transition: "all 0.2s ease",
              ...
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.backgroundColor = "#FF7020")
                }
                onMouseLeave={(e) =>
